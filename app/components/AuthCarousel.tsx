  ...
  const slides: CarouselSlide[] = [
    {
      ...
      description: 'Create a compelling profile that showcases your skills, experience, and achievements.',
    ...
    },
    {
      ...
      description: 'Our intelligent matching system connects you with opportunities aligned with your skills, interests, and aspirations.',
      highlight: 'Discover Opportunities',
    },
    {
      icon: <FileText className="w-12 h-12" />,
      image: '/images/hero/hero-3.jpg',
      title: 'Launch Your Journey',
      description: 'Access internships, jobs, volunteer programmes, and leadership opportunities designed to help you grow and succeed.',
    ...
    },
    {
      ...
      title: 'Quick Apply',
      description: 'Apply seamlessly to opportunities and focus on building your future.',
      highlight: 'Explore Opportunities',
    },
  ];
